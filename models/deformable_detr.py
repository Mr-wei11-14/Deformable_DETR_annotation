...
class DeformableDETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels,
        ...
        # 进一步使用这三个不同尺度的特征，分别接一个1x1conv + GroupNorm，
        # 再进一步Layer4接一个3x3conv + GroupNorm下采样，最后得到四个不同尺度的特征图：
    ...
    def forward(self, samples: NestedTensor):
        ...
        if self.num_feature_levels > len(srcs):
            ...
            # 从 _len_srcs 开始，到 self.num_feature_levels 结束（但不包括 self.num_feature_levels）的整数序列。
        ...
        # [two-stage]
        # query_embeds = None 也就是two-stage时，传入的query_embeds是None
        ...
        for lvl in range(hs.shape[0]):
            ...
            outputs_classes.append(outputs_class)  # [6, bs, 300, 91]
            outputs_coords.append(outputs_coord)  # [6, bs, 300, 4]
